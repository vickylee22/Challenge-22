...
st.title("Star Land Registry & Appraisal System")
...
artwork_name = st.text_input("Enter the name of the planet")
artist_name = st.text_input("Enter the name of the land")
...
if st.button("Register Star Land"):
    ...
    st.markdown(f"[Star Land IPFS Gateway Link](https://ipfs.io/ipfs/{artwork_ipfs_hash})")
    st.markdown(f"[Star Land IPFS Image Link](https://ipfs.io/ipfs/{token_json['image']})")
st.markdown("---")
...
token_id = st.selectbox("Choose a Star Land Token ID", list(range(tokens)))
